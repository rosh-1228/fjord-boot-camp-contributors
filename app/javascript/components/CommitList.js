...
const  CommitInfo = (props) => {
  ...
  return (
    <tr className='commits-commit'>
      <td className='commits-commit__hash is-text-align-center'><a href={'https://github.com/fjordllc/bootcamp/commit/'+hash} className='commits-commit__hash-link' target='_blank' rel='noopener'>{hash.substring(1, 7)}</a></td>
      <td className='commits-commit__date is-nowrap is-text-align-center'>{committed_on}</td>
      <td className='commits-commit__message'><a href={'https://github.com/fjordllc/bootcamp/commit/'+hash} className='commits-commit__message-link' target='_blank' rel='noopener'>{message}</a></td>
    </tr>
  )
}
