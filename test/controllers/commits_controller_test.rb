...
class CommitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commit" do
    assert_difference('Commit.count') do
      post commits_url, params: { commit: { committed_on: @commit.committed_on, contributor: @commit.contributor, hash: @commit.hash, message: @commit.message } }
    end
  ...
  test "should update commit" do
    patch commit_url(@commit), params: { commit: { committed_on: @commit.committed_on, contributor: @commit.contributor, hash: @commit.hash, message: @commit.message } }
